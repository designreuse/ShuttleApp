...
<form:form method="POST" modelAttribute="schedule"
	...
	<div class="row padding-30">
		<div class="col-md-6">
			...
			<form:input class="form-control" placeholder="Route From"
				path="from_location"></form:input>
		</div>
		<div class="col-md-6">
			<label> Route To:</label>
			<form:input class="form-control" type="text" placeholder="Route To"
				path="to_location"></form:input>
		</div>
	</div>
	...
	<div class="row padding-10">
		<div class="col-md-3">
			<label>Time:</label>
			<form:input class="form-control" type="time" placeholder="Time"
				path="dropoff_time"></form:input>
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-6">
			<label>Vehicle:</label>
			<div class="form-group">
				<form:select class="form-control" path="plate_num">
		...
		<div class="col-md-3" id="showSingle">
			<label>Date:</label>
			<form:input class="form-control" type="date" placeholder="Time"
				path="dropoff_date"></form:input>
		</div>
